...
class FraudDetector extends KeyedProcessFunction[Long, Transaction, Alert] {
  ...
  override def open(config: Configuration): Unit = {
    val desc = new ValueStateDescriptor("flag", Types.BOOLEAN)
    flagState = getRuntimeContext.getState(desc)
  ...
  private def cleanup(ctx: KeyedProcessFunction[Long, Transaction, Alert]#OnTimerContext): Unit ={
